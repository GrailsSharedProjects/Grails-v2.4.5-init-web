...
//TODO        grails.serverURL = "http://www.demo.com"
    }
}
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.demo.auth.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.demo.auth.UserRole'
grails.plugin.springsecurity.authority.className = 'com.demo.auth.Role'
...
grails.plugin.springsecurity.ui.register.emailSubject = 'Confirm Registration - Demo'
...
grails.plugin.springsecurity.ui.forgotPassword.emailSubject = 'Reset Password - Demo'
